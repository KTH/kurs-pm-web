...
module.exports = {
  getAllMemosByCourseCodeAndType: [
    {
      ...
      status: 'published',
      version: '1',
      communicationDuringCourse: '<p>Kommunikation i kursen...</p>',
      ethicalApproachThisCourse: '',
      examinationModules: '<h4>Tentamen ( TEN1 )</h4>',
      gradingCriteria: '',
      ...
      __v: 0,
      visibleInMemo: {
        communicationDuringCourse: true,
        otherContacts: true,
      },
    },
  ],
  detailedInformation: {
    ...
    roundInfos: [
      {
        ...
        round: {
          ...
          shortName: 'CMEDT1',
          campus: {
            name: 'KTH Flemingsberg',
            label: 'KTH Flemingsberg',
          },
          selectionCriteriaSv: '<p></p>',
          selectionCriteriaEn: '<p></p>',
          language: 'Svenska',
          targetGroup: '<p>CMEDT1</p>',
          ...
          startDate: 'Nov 1, 2021 12:00:00 AM',
          firstTuitionDate: '2021-11-01',
          lastTuitionDate: '2022-01-17',
        },
      },
      {
        lectureCount: 21,
        ...
        round: {
          ...
          startDate: 'Aug 30, 2021 12:00:00 AM',
          firstTuitionDate: '2021-08-30',
          lastTuitionDate: '2021-10-29',
        },
      },
      {
        lectureCount: 21,
        ...
        round: {
          ...
          selectionCriteriaEn: '<p></p>',
          language: 'Svenska',
          targetGroup: '<p>CMATD1</p><p>CSAMH1</p><p>CTKEM1</p><p>CLGYM MAKE2</p><p>CLGYM TEDA2</p>',
          draftCourseRoundType: {
            code: 'ORD',
            name: 'Programutbildning',
            active: true,
      ...
      },
      {
        ...
        round: {
          ...
          selectionCriteriaEn: '<p></p>',
          language: 'Svenska',
          targetGroup: '<p>CMETE1</p><p>COPEN1</p>',
          draftCourseRoundType: {
            code: 'ORD',
            name: 'Programutbildning',
            active: true,
      ...
      },
      {
        ...
        round: {
          ...
          selectionCriteriaEn: '<p></p>',
          language: 'Svenska',
          targetGroup: '<p>CBIOT2</p><p>CMAST1</p>',
          draftCourseRoundType: {
            code: 'ORD',
            name: 'Programutbildning',
            active: true,
    ...
    publicSyllabusVersions: [
      {
        ...
        courseSyllabus: {
          ...
          content:
            '<p>Vektorer, matriser, linj&#228;ra ekvationssystem, Gausselimination, vektorgeometri med skal&#228;rprodukt och vektorprodukt, determinanter, vektorrum, linj&#228;rt oberoende, baser, basbyten, linj&#228;r avbildning, minsta-kvadratmetoden, egenv&#228;rden, egenvektorer, kvadratiska former, ortogonalitet, inre-produktrum, Gram-Schmidts metod.</p>',
          eligibility: '<p>Grundl&#228;ggande beh&#246;righet.&#160;</p><p><strong><em>&#160;</em></strong></p>',
          literatureComment:
    ...
    socialCoursePageUrl: 'https://www-r.referens.sys.kth.se/social/course/SF1624/',
